...
class df_translator:
    def __init__(self, input_file, output_file, source_column='权利要求', target_column='权利要求 (en)',
                 source_lang='auto', target_lang='en', batch_size=500, max_retries=5, max_len=500, sleep_time=100):
